...
//	@PostMapping("/registration-of-manager")
//	public ResponseEntity<String> registration(@RequestBody SignUpBean signUpBean) {
//		String registrationStatus = signUpService.registration(signUpBean);
...
//		String updateEmployeeStatus	= signUpService.updateEmployee(id, signUpBean);
...
//		String addRoleStatus = signUpService.addRole(roleBean);
